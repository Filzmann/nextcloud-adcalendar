(function () {
    ...
    function utcDateTime(value) { const date = new Date(value); if (Number.isNaN(date.getTime())) throw new Error('Bitte Beginn und Ende vollständig angeben.'); return date.toISOString(); }
