...
- `ShiftCalendarReconciliationService` wählt ausschließlich vorhandene persönliche Opt-ins über den nativen Nextcloud-Benutzerkonfigurationsvertrag aus und stellt deren vollständigen ausgehenden Dienstbestand wieder her. Background-Jobs erhalten dadurch keine zusätzlichen Planungs- oder Leserechte und erzeugen keine zweite Fachdatenhaltung.
