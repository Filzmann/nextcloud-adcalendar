...
foreach (['.adc-calendar tbody th[scope="row"]', 'position: sticky', 'inset-inline-start: 0', '.adc-outside-month', '.adc-month-weeks', '.adc-week-block'] as $contract) {
