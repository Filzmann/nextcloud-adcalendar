...
foreach (['role="tablist"', 'id="adc-tab-calendar"', 'id="adc-tab-settings"', 'id="adc-settings-view"', 'id="adc-shift-defaults-form"', '<details class="adc-filters">', 'id="adc-filter-status"', 'id="adc-save-default"', 'id="adc-reset-selection"', 'Auswahl zurücksetzen', 'id="adc-entry-dialog"', 'id="adc-meeting-dialog"', 'id="adc-meeting-duration"', 'id="adc-meeting-title"', 'class="adc-overview"', 'class="adc-overview-header"', 'class="adc-button-icon icon-calendar-dark" aria-hidden="true"', "script('adcalendar', 'models/organization')", "script('adcalendar', 'modules/calendar-state')", "script('adcalendar', 'components/calendar-filters')", "script('adcalendar', 'components/calendar-cell')", "script('adcalendar', 'components/entry-dialog')", "script('adcalendar', 'components/meeting-finder')", "script('adcalendar', 'components/shift-defaults')", "script('adcalendar', 'components/tab-navigation')", "script('adcalendar', 'components/week-table')"] as $contract) {
