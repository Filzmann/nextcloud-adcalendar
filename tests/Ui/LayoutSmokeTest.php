...
foreach (["\\OCP\\Util::addScript('orgsuite', 'suite-navigation')", "\\OCP\\Util::addStyle('orgsuite', 'suite-navigation')", 'data-orgsuite data-suite="ad" data-current-app="adcalendar"'] as $contract) {
