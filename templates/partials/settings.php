<section id="adc-settings-view" class="adc-settings-view" role="tabpanel" aria-labelledby="adc-tab-settings" hidden>
    <section aria-labelledby="adc-calendar-sync-heading">
        ...
        <p>Nach persönlicher Aktivierung legt AD Kalender den privaten Kalender „AD Dienste“ an und überträgt ausschließlich deine Dienste. AD Kalender bleibt die Quelle der Wahrheit: Änderungen im Zielkalender werden überschrieben und nicht zurückübertragen.</p>
